...
function zodiacData(z_sign){
    document.getElementById("zsigndisplay").innerHTML = z_sign;
    ...
    document.getElementById("birthrange").innerHTML = birthrange;
